...
public interface PersonControllerDocs {
    ...
    @Operation(
        ...
        description = "Export a specific Person data as PDF by their ID",
        tags = {"People"},
        responses = {
            @ApiResponse(
                description = "Success",
    ...
    @Operation(
        ...
        description = "Finds All People by first name",
        tags = {"People"},
        responses = {
            @ApiResponse(
                description = "Success",
    ...
    @Operation(
            ...
            description = "Adds a new Person by passing a JSON/XML/YAML representation of the person",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(
            ...
            description = "Updates a person by passing a JSON/XML/YAML representation of the person",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
